 ...
 *  4. 最後は 'map-marker'
 */
export function convertGooglePlacePredictionTypeToMaterialCommunityIcon(
...
type Category =
    | 'Automotive' | 'Business' | 'Culture' | 'Education' | 'Entertainment and Recreation'
    | 'Facilities' | 'Finance' | 'Food and Drink' | 'Geographical Areas' | 'Government'
    | 'Health and Wellness' | 'Housing' | 'Lodging' | 'Natural Features'
    | 'Places of Worship' | 'Services' | 'Shopping' | 'Sports' | 'Transportation';
