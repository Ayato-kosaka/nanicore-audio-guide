...
export const findOrCreateSpotFromImageUri = async (imageUri: string, requestId: string, userId: string) => {
	...
	return await findOrCreateSpotFromId(spotId, requestId, userId, {
		spotTitle,
		imageUrl: image_url,
