...
const config = {
  ...
  "inlineSchemaHash": "47b3e8a66869135c9524b703a6878c1d3074213cb4b6ca18c19768485519538a",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "functions/src/generated/prisma",
...
path.join(process.cwd(), "functions/src/generated/prisma/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "functions/src/generated/prisma/schema.prisma")
