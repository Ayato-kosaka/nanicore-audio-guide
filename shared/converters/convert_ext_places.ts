...
export type PrismaExtPlaces = Omit<Prisma.Ext_placesGroupByOutputType, '_count' | '_avg' | '_sum' | '_min' | '_max'>;

export type SupabaseExtPlaces = TableRow<'ext_places'>;
 ...
 */
export function convertSupabaseToPrisma_ExtPlaces(supabase: SupabaseExtPlaces): PrismaExtPlaces {
  return {
    id: supabase.id,
 ...
 */
export function convertPrismaToSupabase_ExtPlaces(prisma: PrismaExtPlaces): SupabaseExtPlaces {
  return {
    id: prisma.id,
    title: prisma.title,
