 ...
 */
export function convertSupabaseToPrisma_ExtSpots(supabase: TableRow<'ext_spots'>): Omit<Prisma.Ext_spotsGroupByOutputType, '_count' | '_avg' | '_sum' | '_min' | '_max'> {
  return {
    id: supabase.id,
 ...
 */
export function convertPrismaToSupabase_ExtSpots(prisma: Omit<Prisma.Ext_spotsGroupByOutputType, '_count' | '_avg' | '_sum' | '_min' | '_max'>): TableRow<'ext_spots'> {
  return {
    id: prisma.id,
